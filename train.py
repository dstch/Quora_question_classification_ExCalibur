...
class train():
    def __init__(self):
        ...
        ## Required parameters
        flags.DEFINE_string(
            "data_dir", r'E:\github\Quora_question_classification_ExCalibur\train_data',
            "The input data dir. Should contain the .tsv files (or other data files) "
            "for the task.")

        flags.DEFINE_string(
            "bert_config_file",
            r'E:\github\Quora_question_classification_ExCalibur\raw_data\bert_model\bert_config.json',
            "The config json file corresponding to the pre-trained BERT model. "
            "This specifies the model architecture.")

        flags.DEFINE_string("task_name", 'Quora', "The name of the task to train.")

        flags.DEFINE_string("vocab_file",
                            r'E:\github\Quora_question_classification_ExCalibur\raw_data\bert_model\vocab.txt',
                            "The vocabulary file that the BERT model was trained on.")

        flags.DEFINE_string(
            "output_dir", r'E:\github\Quora_question_classification_ExCalibur\train_model',
            "The output directory where the model checkpoints will be written.")

        ## Other parameters

        flags.DEFINE_string(
            "init_checkpoint", r'E:\github\Quora_question_classification_ExCalibur\raw_data\bert_model\bert_model.ckpt',
