...
@file: GRU_kaggle_code.py
@time: 2019/1/18 14:13
@desc:
"""
...
flags.DEFINE_string("glove_path", "../input/embeddings/glove.840B.300d/glove.840B.300d.txt",
                    "pre-train embedding model path")
...
optimizer = tf.train.AdamOptimizer(
    learning_rate=tf.train.exponential_decay(FLAGS.learning_rate, global_step, 100000, 0.96)).minimize(cost)
